...
ALL_AGENTS = (summary_agent, record_agent, diagnosis_agent, risk_agent, comorbidity_agent, interview_agent)
...
def test_unmeasured_agents_stay_on_the_stronger_side():
    ...
    """
    for agent in (summary_agent, diagnosis_agent, comorbidity_agent, interview_agent):
