 ...
 * 个人配置（桌面）。
 *
 * **改动即时生效并保存，没有「保存」按钮。** 偏好是低风险、可逆、单人操作，
 * 加一步确认是多余的。唯一要二次确认的是「恢复全部默认」——
 * 它会连浮窗布局记忆一起清掉。
 *
 * 这一页与 `/admin`、`/delivery` 同类：**不在 V4.3 原件里**，
 * 所以两道界面闸（fidelity / coverage）不比对它，靠单测守。
 *
